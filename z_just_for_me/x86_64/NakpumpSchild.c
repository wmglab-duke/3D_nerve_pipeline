...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "na_ion");
 	...
 	ivoc_help("help ?1 NaKpumpSchild /Users/eliefarah/ascent/submit/MOD_Files/NakpumpSchild.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/eliefarah/ascent/submit/MOD_Files/NakpumpSchild.mod";
static const char* nmodl_file_text = 
