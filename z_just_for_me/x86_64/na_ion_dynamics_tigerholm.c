...
#define nrn_init _nrn_init__naoiTiger
#define _nrn_initial _nrn_initial__naoiTiger
#define nrn_cur _nrn_cur__naoiTiger
#define _nrn_current _nrn_current__naoiTiger
#define nrn_jacob _nrn_jacob__naoiTiger
#define nrn_state _nrn_state__naoiTiger
#define _net_receive _net_receive__naoiTiger 
#define state state__naoiTiger 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_naoiTiger", _hoc_setdata,
 0, 0
};
 /* declare global and static user variables */
#define D D_naoiTiger
 double D = 1e-07;
#define theta theta_naoiTiger
 double theta = 0.029;
 ...
 "theta_naoiTiger", &theta_naoiTiger,
 "D_naoiTiger", &D_naoiTiger,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 void _na_ion_dynamics_tigerholm_reg() {
	int _vectorized = 1;
  _initlists();
 	ion_reg("na", -10000.);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "diam");
 	...
 	ivoc_help("help ?1 naoiTiger /Users/eliefarah/ascent/submit/MOD_Files/na_ion_dynamics_tigerholm.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/eliefarah/ascent/submit/MOD_Files/na_ion_dynamics_tigerholm.mod";
static const char* nmodl_file_text = 
