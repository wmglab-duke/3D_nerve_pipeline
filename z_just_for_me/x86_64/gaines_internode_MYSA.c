...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 0, "cvodeieq");
 	...
 	ivoc_help("help ?1 gaines_internode_mysa /Users/eliefarah/ascent/submit/MOD_Files/gaines_internode_MYSA.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/eliefarah/ascent/submit/MOD_Files/gaines_internode_MYSA.mod";
static const char* nmodl_file_text = 
