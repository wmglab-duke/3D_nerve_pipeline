    ...
    public static void createEnvironmentPartInstance(
        ...
        if ("Medium_Primitive".equals(pseudonym)) { // set instantiation parameters
            if ("DistalMedium".equals(instanceLabel)) {
                ...
                partInstance.set(
                    "displ",
                    new String[] { "prox_shift_x", "prox_shift_y", "prox_shift_z" }
                );
            }
    ...
    public static IdentifierManager createCuffPartPrimitive(
        ...
        switch (pseudonym) {
            ...
            case "HelicalCuffnContact_Primitive":
                ...
                model.geom(id).inputParam().set("r_n", "0");
                ...
                model.geom("part3").feature("uni1").selection("input").set("swe1", "swe2", "swe4");
                model.geom("part3").feature("uni1").set("contributeto", "csel11");
                model.geom("part3").create("dif1", "Difference");
                model.geom("part3").feature("dif1").selection("input").set("uni1");
                model.geom("part3").feature("dif1").selection("input2").set("swe3");
                model.geom("part3").feature("dif1").set("keep", true);
                model.geom("part3").feature("dif1").set("contributeto", "csel11");
                model.geom("part3").create("del1", "Delete");
                model.geom("part3").feature("del1").selection("input").init();
                model.geom("part3").feature("del1").selection("input").set("uni1");
                model.geom(id).run();
            ...
            case "CuffFill_Primitive":
                ...
                model.geom(id).inputParam().set("r_n", "0 [um]");
                ...
                cf.set("pos", new String[] { "x_shift", "y_shift", "Center-(L_fill/2)" });
                cf.set("r", "Fill_radius");
                cf.set("h", "L_fill");
            ...
            case "LivaNova_Primitive":
                ...
                LNhicsp1
                    ...
                    .set(
                        "pos",
                        new String[] { "r_cuff_in_LN+0.5*thk_cuff_LN", "Center-0.5*L_cuff_LN_PD" }
                    );
                ...
                LNsefp1.set(
                    "posx",
                    "cos(2*pi*((rev_PD_insul_LN/2)-(rev_PD_cond_LN/2)))*(r_cuff_in_LN+thk_cuff_LN/2)"
                );
                LNsefp1.set(
                    "posy",
                    "sin(2*pi*((rev_PD_insul_LN/2)-(rev_PD_cond_LN/2)))*(r_cuff_in_LN+thk_cuff_LN/2)"
                );
                LNsefp1.set(
                    "posz",
                    "Center+(L_cuff_LN_PD)*(((rev_PD_insul_LN/2)-(rev_PD_cond_LN/2))/rev_PD_insul_LN)-(L_cuff_LN_PD/2)"
                );
                LNsefp1.set("r", 1);
                ...
                LNhccxp2
                    .geom()
                    .feature("r2")
                    .set("pos", new String[] { "recess_LN+(thk_elec_LN-thk_cuff_LN)/2", "0" });
                ...
                LNhrcxp2
                    .geom()
                    .feature("r1")
                    .set("pos", new String[] { "recess_LN/2-thk_cuff_LN/2", "0" });
                LNhrcxp2.geom().feature("r1").set("base", "center");
                LNhrcxp2
                    .geom()
                    .feature("r1")
                    .set("size", new String[] { "recess_LN", "w_elec_LN" });
                ...
                model.geom(id).feature("if2").set("condition", "recess_LN==0");
                ...
                model.geom("part3").create("dif1", "Difference");
                model.geom("part3").feature("dif1").selection("input").set("uni1");
                model.geom("part3").feature("dif1").selection("input2").set("swe4");
                model.geom("part3").feature("dif1").set("keep", true);
                model.geom("part3").feature("dif1").set("contributeto", "csel13");
                model.geom("part3").create("del1", "Delete");
                model.geom("part3").feature("del1").selection("input").init();
                model.geom("part3").feature("del1").selection("input").set("uni1");
                model.geom("part3").create("rot1", "Rotate");
                model.geom("part3").feature("rot1").selection("input").set("dif1", "swe4", "pt1");
                model.geom("part3").feature("rot1").set("rot", "corr_LN");
    ...
    public static void createCuffPartInstance(
        ...
        switch (pseudonym) {
            ...
            case "CircleContact_Primitive":
                ...
                try {
                    PrintWriter pr = new PrintWriter(pcsfolder + "/" + id + ".dat");
            ...
            case "HelicalCuffnContact_Primitive":
                ...
                double[] circ_coord = model
                    .component("comp1")
                    .geom("geom1")
                    .measureFinal()
                    .getVtxCoord();
                File circ_dir = new File(pcsfolder);
                if (!circ_dir.exists()) circ_dir.mkdirs();
                try {
                    PrintWriter pr = new PrintWriter(pcsfolder + "/" + id + ".dat");

                    for (int i = 0; i < circ_coord.length; i++) {
                        pr.println(circ_coord[i]);
                    }
                    pr.close();
                } catch (Exception e) {
                    e.printStackTrace();
            ...
            case "CuffFill_Primitive":
                // set instantiation parameters
                String[] cuffFillParameters = { "Thk", "Center", "x_shift", "y_shift", "r_n" };
            ...
            case "LivaNova_Primitive":
                // set instantiation parameters
                String[] LivaNovaParameters = { "Center", "r_n" };
                ...
                double[] coordLN = model
                    .component("comp1")
                    .geom("geom1")
                    .measureFinal()
                    .getVtxCoord();
                File dirLN = new File(pcsfolder);
                if (!dirLN.exists()) dirLN.mkdirs();
                try {
                    PrintWriter pr = new PrintWriter(pcsfolder + "/" + id + ".dat");

                    for (int i = 0; i < coordLN.length; i++) {
                        pr.println(coordLN[i]);
                    }
                    pr.close();
                } catch (Exception e) {
                    e.printStackTrace();
