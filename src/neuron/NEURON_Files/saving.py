...
class Saving(Configurable):
    ...
    def write2file(self, recording, runtime, fiber, dt, amp_ind=0):
        ...
        def create_space_vectors(saving_times, recording_vectors):
            space_vectors = [[] for t in self.time_inds]
        ...
        if self.space_vm:
            ...
            vm_space_vectors = create_space_vectors(self.time_inds, recording.vm)
        ...
        if self.space_gating:
            ...
            for gating_param, gating_vector in zip(gating_params, recording.gating):
                ...
                gating_space_vectors = create_space_vectors(self.time_inds, gating_vector)
        ...
        if self.time_vm:
            ...
            file_lines = create_file_lines(recording.time, vm_time_vectors, 'time', 'vm', 'mV')
        ...
        if self.time_gating:
            ...
            for gating_param, gating_vector in zip(gating_params, recording.gating):
                ...
                file_lines = create_file_lines(recording.time, gating_time_vectors, 'time', gating_param)
        ...
        if self.istim:
            ...
            file_lines = create_file_lines(recording.time, recording.istim, 'time', 'istim', 'nA')
