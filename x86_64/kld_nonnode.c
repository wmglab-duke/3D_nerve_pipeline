...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "diam");
 	...
 	ivoc_help("help ?1 kld_nonnode /Users/eliefarah/ascent/MOD_Files/kld_nonnode.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/eliefarah/ascent/MOD_Files/kld_nonnode.mod";
static const char* nmodl_file_text = 
  "NEURON {\n"
  "  SUFFIX kld_nonnode\n"
