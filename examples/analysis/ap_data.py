...
dat2d = q.ap_data(delta_V=60, absolute_voltage=False, delete_vmtime=True)

dat3d = q.ap_data(delta_V=60, absolute_voltage=False, delete_vmtime=True, sample_override=samp3d)
