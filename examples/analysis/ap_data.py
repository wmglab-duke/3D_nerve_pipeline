...
#need to add ap extration for 3D, then copy code from other script for matching 2d to 3d, then can compare (paired boxplot as well as xy fiber plot, maybe also plot all fibers)