...
analyses = ['fascicle_count', 'total_endo_area', 'total_nerve_area', 'total_epineurium_area', 'endo-nerve_ratio', 'mean_inner_area']
#lineplot for each
...
analysis = grouped.agg({'mean_inner_area': [np.mean, np.std], 'total_endo_area': [np.mean, np.std], 'total_nerve_area': [np.mean, np.std], 'total_epineurium_area': [np.mean, np.std], 'endo-nerve_ratio': [np.mean, np.std], 'fascicle_count': [np.mean, np.std, np.min, np.max]})
