...
# spans = list(zip(np.arange(10000, 40000,1000), np.arange(11000, 41000,1000)))
# names = [str(x) for x in range(len(spans))]
...
twoodvpath = rf'D:\threed_final\samples\{samp2d}\models\0\sims\{simnum}\n_sims\0\data\inputs\inner0_fiber0.dat'
