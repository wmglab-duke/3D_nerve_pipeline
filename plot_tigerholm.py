...
paper_x, paper_y = [], []
with open("submit/n_sims/0_0_2_0/data/outputs/zoomed_in.csv", 'r') as file:
...
# magenta -- red and blue on top of each other
# the remaining are all on top of each other